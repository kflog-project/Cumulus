        ...
        : QObject(parent), scaleIndex(0), isSwitch(false)
{
    ...
    topographyColorList.setAutoDelete(true);
    ...
    airFPenList.setAutoDelete(true);
    airFBrushList.setAutoDelete(true);
    ...
    suSectorPenList.setAutoDelete(true);
    suSectorBrushList.setAutoDelete(true);
    ...
    cityBrushList.setAutoDelete(true);
