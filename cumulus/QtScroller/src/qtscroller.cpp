...
/*!
    ...
    set to QtScroller::LeftMouseButtonGesture the gesture triggers on touch events. If it is set to
...
Qt::GestureType QtScroller::grabGesture(QObject *target, ScrollerGestureType scrollGestureType)
{
    ...
    default                      :
    case QtScroller::TouchGesture            : button = Qt::NoButton; break; // NoButton == Touch
    }
    ...
    if (target->isWidgetType()) {
        ...
        if (scrollGestureType == QtScroller::LeftMouseButtonGesture)
...
/*!
    ...
    \value QtScroller::LeftMouseButtonGesture The gesture recognizer will only trigger on touch
