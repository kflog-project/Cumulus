...
LatEdit::LatEdit(QWidget *parent, const char *name, const int base) : CoordEdit(parent, name)
{
...
LongEdit::LongEdit(QWidget *parent, const char *name, const int base) : CoordEdit(parent, name)
{
    if( WGSPoint::getFormat() != WGSPoint::DDM ) {
...
/** Returns the value of the editbox in the KFLog internal format for degrees  */
