 ...
 */
ElevationImage::ElevationImage( QColor colors[], QWidget *parent ) :
  QWidget(parent)
{
...
QSize ElevationImage::sizeHint() const
{
  return QSize(140, 480);
}

QSize ElevationImage::minimumSizeHint() const
{
...
void ElevationImage::paintEvent( QPaintEvent * /* event */ )
{
